...
- 🎨 [**Devmunity**](https://www.devmunity.com/) - A portfolio with stunning visuals for an agency.
- 🛠️ [**Diginergy Talent**](https://talent.diginergy.info/) - A platform for recruiters from **Germany** to hire people from **Indonesia**.
- 🎨 [**AI-Powered Web App**](https://www.kaia.team/) - A chatbot that integrates to your website as a widget.
